...
// ------------------------------------------------------------------
const LESSON_TITLE = "211: 생태계 구성요소와 상호작용";
// ------------------------------------------------------------------
...
const quizData = [
  ...
  },
  {
    ...
    "options": ["O", "X"],
    "correctAnswer": 0,
    "explanation": "풀이: 맞습니다. 개체 < 개체군(같은 종의 모임) < 군집(여러 종의 모임) < 생태계 순으로 구성됩니다."
  },
  {
    "type": "ox",
    ...
    "options": ["O", "X"],
    "correctAnswer": 1,
    "explanation": "풀이: 사막여우는 '더운' 지역에 살며 열 방출을 위해 귀가 큽니다. 몸집이 크고 귀가 작은 것은 추운 지역에 사는 북극여우의 특징입니다."
  },
  {
    "type": "ox",
    ...
    "options": ["O", "X"],
    "correctAnswer": 1,
    "explanation": "풀이: 지렁이(생물)가 토양(비생물)에 영향을 주는 것이므로, 생물요소가 비생물요소에 영향을 미치는 '작용'의 예입니다."
  },
  {
    "type": "ox",
    ...
    "options": ["O", "X"],
    "correctAnswer": 0,
    "explanation": "풀이: 물속 환경에서는 산소가 부족할 수 있으므로 공기 통로인 통기조직이 발달하는 적응 현상을 보입니다."
  },
  ...
  // --- CEI 글쓰기 문제 1개 (11) ---
  {
    ...
    "explanation": "CEI 구조 (C: 주장, E: 근거, I: 해석)에 맞게 곶자왈 보존의 필요성과 생태계적 가치에 대한 자신의 생각을 서술합니다."
  }
];
// ------------------------------------------------------------------
